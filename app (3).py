...
# Load Model & Scaler
model = joblib.load('tuned_decision_tree_regressor_model.pkl')
...
with col2:
    ...
    if st.button("Generate Prediction Report"):
        # Predict Logic
        # The order of features in this array must match the order in X.columns that the model was trained on.
        # X.columns are: 'Flow Rate (ml/min)', 'Inlet Diameter (mm)', 'Vol  Avg Shear Rate (1/s)', 'Max Wall Shear Rate (1/s)', '95th % Wall Shear Rate (1/s)', 'Throat Avg Shear Rate (1/s)', 'Vol. Avg Exposure Time (s)', 'Max Exposure Time (s)', 'Throat Exposure Time (s)', 'Hydraulic Diameter (mm)', 'Device Type Encoded'
